...
do
	# Runninh independent
	 ...
	 # RUNNINIG THE QoS-DRIVEN SCHEDULER with safety margin 30
        ...
        ./prepara_ambiente.sh
        cd ../brokerv2/
        ./run_experiment.sh workloads/synthetic-workload1-5hosts-10pods-per-host-multiple-controllers-2-parallel-all-task_aggregated.csv 3600
	...
	cd ../cloudish-cluster/
 	...
 	bash configure_schedulerv2.sh 30.0 true 0.0 kube-priority-scheduler:v0.2.1
        ...
        ./prepara_ambiente.sh
        cd ../brokerv2/
        ./run_experiment.sh workloads/synthetic-workload1-5hosts-10pods-per-host-multiple-controllers-2-parallel-all-job-free.csv 3600
	...
	#./run_experiment.sh workloads/synthetic-workload1-5hosts-10pods-per-host-multiple-controllers-4-replicas-all-independent.csv 3600
	 ...
	 # RUNNINIG THE QoS-DRIVEN SCHEDULER with safety margin 30
       ...
       # # RUNNINIG THE QoS-DRIVEN SCHEDULER with safety margin 30
        ...
        ./prepara_ambiente.sh
        cd ../brokerv2/
        ./run_experiment.sh workloads/synthetic-workload1-5hosts-10pods-per-host-multiple-controllers-4-parallel-all-job-free.csv 3600
       # ./run_experiment.sh workloads/synthetic-workload1-5hosts-10pods-per-host-multiple-controllers-1-replicas-all-independent.csv 3600
        #./run_experiment.sh workloads/synthetic-workload1-5hosts-10pods-per-host-multiple-controllers-4-replicas-all-independent.csv 3600
